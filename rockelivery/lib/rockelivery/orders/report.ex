defmodule Rockelivery.Orders.Report do
  ...
  defp order_string(%Order{user_id: user_id, payment_method: payment_method, items: items}) do
  ...
  defp item_string(%Item{description: description, category: category, price: price}) do
