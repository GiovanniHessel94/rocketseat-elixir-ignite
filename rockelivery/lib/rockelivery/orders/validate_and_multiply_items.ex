defmodule Rockelivery.Orders.ValidateAndMultiplyItems do
  def call(items, items_ids, items_params) do
    ...
    |> do_multiply_items(items_map, items_params)
  end

  defp do_multiply_items(true, _items_map, _items_params), do: {:error, "Invalid ids!"}

  defp do_multiply_items(false, items_map, items_params) do
    items =
